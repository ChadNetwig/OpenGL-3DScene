...
public:
    ...
    // CLN: Changed getVertices() to float to ensure compatibility with main code (was const float)
    float* getVertices()         { return vertices.data(); }
    const float* getNormals() const         { return normals.data(); }
    const float* getTexCoords() const       { return texCoords.data(); }
    // CLN: Changed getIndices() to unsigned short to ensure compatibility with main code (was const unsigned int)
    unsigned short* getIndices()  { return indices.data(); }
    ...
    // CLN: Commented draw functions because draws are done in main code
    /*
...
private:
    ...
    // CLN: Changed indices to unsigned short to ensure compatiblity with main code
