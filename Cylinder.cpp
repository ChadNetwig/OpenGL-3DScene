...
///////////////////////////////////////////////////////////////////////////////////////
// Updated by: Chad Netwig
// Date      : 02-07-2022
// Notes     : Comments of changes have been made throughout and are preceded by "CLN:"
///////////////////////////////////////////////////////////////////////////////////////

// CLN: Removed OpenGL libraries here because they're loaded in main code
/*
#ifdef _WIN32
...
// CLN: Removed all draw methods, as these are done in main code and not needed here
/*
...
void Cylinder::clearArrays()
{
    ...
    // CLN: Changed indices to unsigned short to be compatible with main code functions
...
void Cylinder::buildInterleavedVertices()
{
    ...
    for(i = 0, j = 0; i < count; i += 3, j += 2)
    {
        ...
        //CLN: commented the following  interleavedVertices out because included texCoords in vertices vector
...
void Cylinder::addNormal(float nx, float ny, float nz)
{
    ...
    // CLN: added vertices because expected by stride attribute in glVertexAttribPointer for normals
...
void Cylinder::addTexCoord(float s, float t)
{
    ...
    // CLN: added vertices because expected by stride attribute in glVertexAttribPointer
